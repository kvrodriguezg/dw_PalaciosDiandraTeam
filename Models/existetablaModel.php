...
class ExisteTabla
{
    ...
    {
        $this->crearTabla("Perfiles", "IDPerfil INT PRIMARY KEY AUTO_INCREMENT, TipoPerfil VARCHAR(50) UNIQUE NOT NULL");
        $this->crearTabla("CentrosMedicos", "IDCentroMedico INT PRIMARY KEY AUTO_INCREMENT, NombreCentro VARCHAR(100) UNIQUE NOT NULL, codigo VARCHAR(5) UNIQUE NOT NULL");
        ...
        $this->crearTabla("Diagnosticos", "CodigoDiagnosticos VARCHAR(5) PRIMARY KEY NOT NULL, Diagnostico VARCHAR(100) UNIQUE NOT NULL");
        ...
        $this->crearTabla("Examenes", "IDExamen INT PRIMARY KEY AUTO_INCREMENT, NombreExamen VARCHAR(100) NOT NULL, RutPaciente VARCHAR(12) NOT NULL, IDCentroSolicitante INT NOT NULL, IDEstado INT NOT NULL, CodigoDiagnosticos VARCHAR(5), FechaTomaMuestra DATE NOT NULL, FechaRecepcion DATE NOT NULL, Fechatincion DATE, Fechadiagnostico DATE, FOREIGN KEY (CodigoDiagnosticos) REFERENCES Diagnosticos(CodigoDiagnosticos), FOREIGN KEY (IDCentroSolicitante) REFERENCES CentrosMedicos(IDCentroMedico), FOREIGN KEY (RutPaciente) REFERENCES Pacientes(RutPaciente), FOREIGN KEY (IDEstado) REFERENCES Estados(IDEstado)");
