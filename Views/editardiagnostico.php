...
<h2 style="text-align: center;">Editar Diagnóstico</h2><br>
    <div class="row">
        <div class="col">
            ...
            <input type="text" class="form-control" name="nombre" placeholder="1" readonly>
        </div>
    </div>
    <br>
    <div class="row">
        <div class="col">
            ...
            <input type="text" class="form-control" name="nombre" placeholder="A">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            ...
            <input type="text" class="form-control" name="nombre" placeholder="lorenm ipsum">
        </div>
    </div>
