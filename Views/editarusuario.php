...
<h2 style="text-align: center;">Crear usuario</h2><br>
    <div class="row">
        <div class="col">
            ...
            <input type="text" class="form-control" name="nombre" placeholder="luis yañez">
        </div>
        <div class="col">
            <label for="nombre">Ingrese Rut</label>
            <input type="text" class="form-control" name="rut" placeholder="17426433-5">
        </div>
    </div>
    ...
    <div class="col">
            ...
            <input type="text" class="form-control" name="rut" placeholder="lyanez">
        </div>
        <div class="col">
            <label for="materno">Clave Ingreso</label>
            <input type="text" class="form-control" name="CentroMedico" placeholder="lyanez17426433-5">
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col">
            <label for="nivel">Centro Medico</label>
            <div class="dropdown">
                <button class="btn btn-warning dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                N/A
                </button>
    ...
    <br><br><br>
    <a href="creacionusuarios.php" class="btn btn-primary w-100 center-block" >Crear Diagnostico</a>
</form>
